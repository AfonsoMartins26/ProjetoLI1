...
module LI12324 (
    -- * Tipos de dados
    -- ** Básicos
    Posicao, Velocidade, Tempo, Tamanho, Hitbox, Direcao(..), Semente,
    -- ** Mapas
...
-- mudar os blocos para escada , plataforma , alcapao , vazio 
...
gerarRAngeN :: Int -> Int -> Int -> [Int]
gerarRAngeN n limite seed =
    let listaAleatorios = take n $ randoms (mkStdGen seed )
    in map (\k -> mod k limite) listaAleatorios
{-
gerarRAngeN2 :: Int -> Int -> Int -> [Int]
gerarRAngeN2 n limite tempo = 
